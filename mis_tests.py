# here are some comprehensive tests, these are "proof" of all mis known properties, have in mind the invariance breaks down with time very quickly we need to learn about it further
